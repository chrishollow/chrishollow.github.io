...
const TRANSLATIONS = {
  en: {
    ...
    'contact.heading':"Let's discuss your project",'contact.name_ph':'Your name','contact.email_ph':'Your email',
    ...
    'skills.heading':'Technical & Leadership Skills','skills.p':'A comprehensive skill set combining technical development expertise with project management and leadership abilities gained through diverse professional experiences.',
    ...
    'about_page.p1':'A highly motivated professional based in Brussels, Belgium, with a passion for technology and continuous learning. My journey spans from paramedical studies to becoming an IT technician, web developer, and project manager, demonstrating adaptability and a commitment to mastering new skills.',
    ...
    'about_page.insp_heading':'Who and what shaped my values','about_page.spiritual_role':'Spiritual Activist','about_page.beauvoir_role':'Author, Feminist Activist',
  ...
  fr: {
    ...
    'contact.heading':'Discutons de votre projet','contact.name_ph':'Votre nom','contact.email_ph':'Votre e-mail',
    ...
    'skills.heading':'Compétences Techniques & en Leadership','skills.p':'Un ensemble de compétences polyvalentes combinant expertise technique en développement et capacités de gestion de projet, acquises grâce à des expériences professionnelles diversifiées.',
    ...
    'test.heading':'Ce que disent mes collègues sur notre collaboration.',
    ...
    'about_page.hello':'Bonjour,',
    'about_page.p1':"Professionnel très motivé basé à Bruxelles, Belgique, passionné par la technologie et l'apprentissage continu. Mon parcours s'étend des études paramédicales à technicien IT, développeur web et chef de projet.",
    ...
    'about_page.sincerity':'Sincérité','about_page.sincerity_p':"S'engager à l'authenticité et à l'honnêteté dans toutes les interactions. Construire la confiance grâce à une communication transparente et un engagement authentique.",
    ...
    'about_page.whyme_heading':'Ce qui me distingue ?','about_page.whyme_p':"Un mélange unique d'expertise technique, de compétences en communication et de perspective internationale, acquis grâce à des expériences professionnelles diversifiées et à la formation Erasmus+.",
    ...
    'about_page.insp_heading':'Qui et quoi ont façonné mes valeurs','about_page.spiritual_role':'Activiste Spirituel','about_page.beauvoir_role':'Autrice, Militante féministe',
  ...
  nl: {
    ...
    'contact.heading':'Laten we uw project bespreken','contact.name_ph':'Uw naam','contact.email_ph':'Uw e-mail',
    ...
    'skills.heading':'Technische & Leiderschapsvaardigheden','skills.p':'Een uitgebreide set vaardigheden die technische expertise combineert met projectbeheer en leiderschapskwaliteiten opgedaan door diverse professionele ervaringen.',
    ...
    'test.heading':"Wat collega's zeggen over samenwerken met mij.",
    ...
    'about_page.insp_heading':'Wie en wat mijn waarden hebben gevormd','about_page.spiritual_role':'Spiritueel Activist','about_page.beauvoir_role':'Auteur, Feministische Activist',
...
(function () {
  ...
  function buildSwitcherCSS() {
    ...
    style.textContent = [
      ...
      '@media only screen and (max-width:991px){.lang-switcher{right:52px;top:50%}.lang-toggle{padding:4px 10px 4px 8px;font-size:12px;border-radius:16px}.lang-globe{font-size:13px}.lang-dropdown{right:0;min-width:120px}}'
    ].join('');
